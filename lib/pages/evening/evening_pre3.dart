...
class EveningPre3 extends StatefulWidget {
  final int initialValue;

  const EveningPre3({super.key, this.initialValue = 0});

  @override
  State<EveningPre3> createState() => _EveningPre3State();
}

class _EveningPre3State extends State<EveningPre3> {
  int currentValue = 2;
      ...
      home: Scaffold(
        body: Column(
          children: [
            ...
            SizedBox(height: 30),
            Text("Write a short summary of your day?",
